...
[wxID_SIDEKA, wxID_SIDEKAGAMBAR_LOGO, wxID_SIDEKAGARIS_ATAS, 
 wxID_SIDEKAKOTAK_ADMINISTRASI, wxID_SIDEKAKOTAK_KEMISKINAN, 
 wxID_SIDEKAKOTAK_MENU_UTAMA, wxID_SIDEKAKOTAK_POTENSI, 
 wxID_SIDEKAKOTAK_STATISTIK, wxID_SIDEKAKOTA_PENDUDUK, wxID_SIDEKASTATICLINE2, 
 wxID_SIDEKASTATICTEXT3, wxID_SIDEKASTATICTEXT4, wxID_SIDEKASTATICTEXT5, 
 wxID_SIDEKATOMBOL_BANTUAN, wxID_SIDEKATOMBOL_CARI_ADMINISTRASI, 
 wxID_SIDEKATOMBOL_CARI_PENDUDUK, wxID_SIDEKATOMBOL_EDIT_DATA_KEMISKINAN, 
 wxID_SIDEKATOMBOL_EDIT_PENDUDUK, wxID_SIDEKATOMBOL_EDIT_PROFIL, 
 wxID_SIDEKATOMBOL_EDIT_SURAT, wxID_SIDEKATOMBOL_EKONOMI, 
 wxID_SIDEKATOMBOL_INPUT_PROFIL, wxID_SIDEKATOMBOL_INVENTARIS_DESA, 
 wxID_SIDEKATOMBOL_KELUAR, wxID_SIDEKATOMBOL_KEPENDUDUKAN, 
 wxID_SIDEKATOMBOL_LAHAN, wxID_SIDEKATOMBOL_LAPORAN_ADMINISTRASI, 
 wxID_SIDEKATOMBOL_LAPORAN_KEMISKINAN, wxID_SIDEKATOMBOL_LAPORAN_PENDUDUK, 
 wxID_SIDEKATOMBOL_LAPORAN_POTENSI, wxID_SIDEKATOMBOL_LAPORAN_PROFIL, 
 wxID_SIDEKATOMBOL_LAPORAN_STATISTIK, wxID_SIDEKATOMBOL_PARIWISATA, 
 wxID_SIDEKATOMBOL_PASSWORD, wxID_SIDEKATOMBOL_PECAH_KELUARGA, 
 wxID_SIDEKATOMBOL_PENCARIAN_KEMISKINAN, wxID_SIDEKATOMBOL_SINKRON, 
 wxID_SIDEKATOMBOL_STATISTIK_ADMINISTRASI, 
...
class sideka(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        # bagian atas tombol sinkron dan bantuan
       ...
       self.staticText3 = wx.StaticText(id=wxID_SIDEKASTATICTEXT3,
              label=u' SIDEKA ONLINE :', name='staticText3', parent=self,
              pos=wx.Point(304, 16), size=wx.Size(112, 17), style=0)
       ...
       self.tombol_password = wx.lib.buttons.GenBitmapTextButton(bitmap=wx.Bitmap('png/security1.png',
        ...
        self.profil_desa = wx.StaticText(id=wxID_SIDEKASTATICTEXT4,
              label=u'PROFIL DESA', name='profil_desa', parent=self,
        ...
        self.garis_dalam = wx.StaticLine(id=wxID_SIDEKASTATICLINE2,
              name='garis_dalam', parent=self, pos=wx.Point(24, 152),
              size=wx.Size(184, 2), style=0)

        # Kotak menu penduduk
        self.kotak_penduduk = wx.StaticBox(id=wxID_SIDEKAKOTA_PENDUDUK,
              label=u'PENDUDUK', name=u'kotak_penduduk', parent=self,
        ...
        self.staticText5 = wx.StaticText(id=wxID_SIDEKASTATICTEXT5,
              label=u'Prakarsa Desa 2015', name='staticText5', parent=self,
